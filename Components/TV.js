...
function TVDetails({route}) {
  ...
  const [url, setUrl] = useState('https://img.freepik.com/free-vector/cinema-room-background_1017-8728.jpg?w=740&t=st=1683584731~exp=1683585331~hmac=ebce8994bf7a38c6fb4635826a24171db72d5825a4a9c2709b7548f8227d4d8c');
    ...
    <ScrollView style={styles.container}>
      {isLoading ? (
        ...
        <>
          ...
          style={{ width: 415, height: 120 }}   allowsFullscreenVideo={true} key={url}
          />} 
          </View>  
